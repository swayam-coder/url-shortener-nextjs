...
import { AuthInfo, AxiosResponseModified, UrlMetaData } from "../../../interfaces_and_types";
import { Dispatch, SetStateAction } from "react";
import { mainQueryKeys } from "../query-keys";
...
export function useHistoryQuery(logininfo: AxiosResponseModified) {
