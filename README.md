#### * Currently rearranging this project to a monorepo setup with Golang + Gin backend: [See monorepo branch](https://github.com/swayam-coder/url-shortener-nextjs/tree/monorepo)
