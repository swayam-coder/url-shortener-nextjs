#### * Rearranging this project in a monorepo setup with Golang + Gin backend:- [see monorepo branch](https://github.com/swayam-coder/url-shortener-nextjs/tree/monorepo)
